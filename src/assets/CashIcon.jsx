...
const CashIcon = (props) => (
  ...
  >
    <defs>
      <style>{".cls-1{fill:#427d2a;fill-rule:evenodd}"}</style>
    </defs>
    <title>{"cash"}</title>
    <path
      className="cls-1"
      d="M13.37 0h109.51v60.77h-7.74l.54-44.59v-.53a7.14 7.14 0 0 0-7.13-7.14h-95.2V0ZM0 14.42h109.51v56.84H0V14.42Z"
    />
    <path
      d="M91.72 23.25a8.28 8.28 0 0 0 8 8.11v22.49a8.51 8.51 0 0 0-8.5 8.71h-72.8a8.38 8.38 0 0 0-8.06-8.5V31.57a8.43 8.43 0 0 0 8.52-8.32Z"
      style={{
        fill: "#87cc71",
        fillRule: "evenodd",
      }}
